        ...
        {results.map((result, index) => (
          ...
          >
            {result.error ? (
              ...
              <Row gutter={16}>
                <Col span={8}>
                  <Statistic title="处理总数" value={result.response.data.total} size="small" />
                </Col>
                <Col span={8}>
                  <Statistic title="新增" value={result.response.data.inserted || 0} size="small" />
                </Col>
                <Col span={8}>
                  <Statistic title="错误" value={result.response.data.errors || 0} size="small" />
                </Col>
              </Row>
            )}
          </Card>
