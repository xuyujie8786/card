export default {
  ...
  'menu.virtual-cards': 'Cartões Virtuais',
  'menu.audit': 'Auditoria',
  'menu.statement': 'Extrato',
  'menu.operation-logs': 'Logs de Operação',
  'menu.account-flows': 'Fluxos de Conta',
  'menu.announcements': 'Anúncios',
  'menu.announcement-management': 'Gerenciamento de Anúncios',
  'menu.user-management': 'Gerenciamento de Usuários',
};
