export default {
  ...
  'menu.virtual-cards': 'Kartu Virtual',
  'menu.audit': 'Audit',
  'menu.statement': 'Laporan',
  'menu.operation-logs': 'Log Operasi',
  'menu.account-flows': 'Aliran Akun',
  'menu.announcements': 'Pengumuman',
  'menu.announcement-management': 'Manajemen Pengumuman',
