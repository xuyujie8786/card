export default {
  ...
  'menu.virtual-cards': 'کارت‌های مجازی',
  'menu.audit': 'حسابرسی',
  'menu.statement': 'صورتحساب',
  'menu.operation-logs': 'گزارش عملیات',
  'menu.account-flows': 'جریان حساب',
  'menu.announcements': 'اعلانات',
  'menu.announcement-management': 'مدیریت اعلانات',
  'menu.user-management': 'مدیریت کاربران',
};
