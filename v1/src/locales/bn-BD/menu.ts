export default {
  ...
  'menu.virtual-cards': 'ভার্চুয়াল কার্ড',
  'menu.audit': 'অডিট',
  'menu.statement': 'বিবৃতি',
  'menu.operation-logs': 'অপারেশন লগ',
  'menu.account-flows': 'অ্যাকাউন্ট ফ্লো',
  'menu.announcements': 'ঘোষণা',
  'menu.announcement-management': 'ঘোষণা ব্যবস্থাপনা',
